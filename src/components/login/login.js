...
function Login() {
  ...
  const handleLogin = async () => {
    ...
    const response = await fetch(`https://saidililia.pythonanywhere.com/login?wilaya=${wilaya}&password=${passwordValue}&commune=${commune}`);
  ...
  const navigateToPage = (token) => {
    ...
    fetch(`https://saidililia.pythonanywhere.com/facture?commune=${commune}`, { headers })
